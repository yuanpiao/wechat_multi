 ...
 **/
@Service
public class WxMulitConfigWebServiceImpl implements WxMulitConfigWebService{
    ...
    public List<WxMulitConfigDto> getAllWxConfig() {
        ...
        List<WxMulitConfigDto> list = new ArrayList<>();
        for (Object object : objects) {
            String s = JSONObject.toJSONString(object);
            list.add(JSONObject.parseObject(s, WxMulitConfigDto.class));
        }
        return list;
    }
}
